...
onMounted(() => store.dispatch("brands/fetchBrandsData"));
    ...
    <section>
        <div v-for="(item,index) in brands" :key="index" :class="[
            ...
            <div class="w-full md:w-1/2">
                <img class="object-fill w-full h-full" :src="item.img" alt="">
            </div>
            <div :class="[
                ...
                <div :class="['w-full md:grid', (index % 2 === 0) ? 'md:place-content-start' : 'md:place-content-end']">
                    <img class="object-cover w-full h-auto" :src="item.icon" alt="">
                </div>
