  ...
  <main-layout>
    ...
    <div class="w-[550px] p-6 bg-white border border-gray-300  ">
      <div class="flex">
        ...
        <div>
          <h2 class="font-medium md:font-bold">FINICULAR</h2>
          <h2 class="font-medium md:font-bold">Chef</h2>
        </div>
        <div class="py-6 ml-[190px]">
          <h2 class="font-medium md:font-bold">4000 ₾ per month</h2>
        </div>
      </div>
      <p class="mb-3 font-normal text-gray-700 dark:text-black">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestiae amet veniam, est nisi alias nobis eligendi quo odio asperiores corrupti quibusdam beatae dolorem dolore. Unde fugit consectetur placeat ullam eaque?</p>
      <div class="flex">
        <div>
          <p class="pb-1.5"><span class="font-medium md:font-bold">Full time</span> 00:09-00:17:00</p>
          <p>march 25, 2023 - 10:25</p>
        </div>
        <div class="ml-[180px]">
          <a href="#" class="inline-flex items-center px-[25px] py-3 text-sm  text-center text-black bg-zinc-200">
            VIEW DETAILS
          </a>
        </div>
      </div>
    </div>
      <div class="w-[550px] pb-1.5	 p-6 bg-white border border-gray-300  ">
        <div class="flex">
          <img class="h-12" src="https://www.gmt.ge/uploads_script/news/596e27ljb1c75l4.jpg">
          <div>
            <h2 class="font-medium md:font-bold">FINICULAR</h2>
