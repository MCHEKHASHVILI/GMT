...
<template>
  <main-layout>
    ...
    <div class="w-[550px] p-6 bg-white border border-gray-200  ">
      <div class="flex">
        <img class="h-12" src="https://www.gmt.ge/uploads_script/news/596e27ljb1c75l4.jpg">
        <div>
          <h2 class="font-medium">FINICULAR</h2>
          <h2 class="font-medium">Chef</h2>
        </div>
        <div class="py-6 ml-[150px]">
          <h2 class="font-medium">4000 ₾ per month</h2>
        </div>
      </div>
      ...
      <div class="flex">
        <div>
          <p class="pb-1.5"><span class="font-medium">Full time</span> 00:09-00:17:00</p>
          <p>march 25, 2023 - 10:25</p>
        </div>
        <div class="ml-[180px]">
          <a href="#" class="inline-flex items-center px-[25px] py-3 text-sm font-medium text-center text-black bg-zinc-200">
            VIEW DETAILS
          </a>
        </div>
      </div>
    </div>
      <div class="w-[550px] pb-1.5	 p-6 bg-white border border-gray-200  ">
        <div class="flex">
          <img class="h-12" src="https://www.gmt.ge/uploads_script/news/596e27ljb1c75l4.jpg">
          <div>
            <h2 class="font-medium">FINICULAR</h2>
      ...
      <div class="flex justify-center	 gap-[15px] pb-1.5 ml-[150px]">
        <div class="w-[550px] p-6 bg-white border border-gray-200  ">
          <div class="flex">
            ...
            <div>
              <h2 class="font-medium">PURI GULIANI</h2>
              <h2 class="font-medium">Chef</h2>
            </div>
            <div class="py-6 ml-[150px]">
              <h2 class="font-medium">4000 ₾ per month</h2>
      ...
      <div class="flex justify-center	 gap-[15px] ml-[150px]">
        <div class="w-[550px] p-6 bg-white border border-gray-200  ">
          <div class="flex">
            ...
            <div>
              <h2 class="font-medium">RIGI GASTRODOUQAN</h2>
              <h2 class="font-medium">Chef</h2>
            </div>
            <div class="py-6 ml-[150px]">
              <h2 class="font-medium">4000 ₾ per month</h2>
