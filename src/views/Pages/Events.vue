...
export default {
  ...
  computed: {
    ...mapGetters('events', ['title', 'subtitle', 'cover', 'events', 'loading', 'next_page'])
  },
  methods: {
...
<template>
  <main-layout>
    ...
    <EventsHeroSection :title="subtitle" :cover="cover" class="md:container md:mx-auto pb-4 md:pb-6" />
