        ...
        <div class="flex flex-col px-4 md:px-0 py-8 md:w-1/2 md:items-start items-left md:justify-end">
          ...
          <div class="w-10/12 md:w-8/12 md:flex-row flex-col text-lg flex gap-4">
            <a :href="brand?.menu" target="_blank"
              class="bg-[#f5f5f5] flex items-center justify-center py-3 transition duration-300 hover:bg-[#0b0b0b] hover:text-[#d0a958] md:py-6 md:w-1/2">MENU</a>
            <a :href="brand?.website" target="_blank"
              class="bg-[#0b0b0b] flex items-center justify-center transition py-3 duration-300 hover:opacity-80 text-[#d0a958] md:py-6 md:w-1/2">GO
              TO WEBSITE</a>
          </div>
